...
import com.biblio.dto.response.CountCustomerJoinResponse;
 ...
 */
@WebServlet("/owner/ecommerce/list-count-new-customer")
public class GetListCountNewCustomerAPI extends HttpServlet {
    @Serial
     ...
     */
    public GetListCountNewCustomerAPI() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<CountCustomerJoinResponse> countCustomerJoinResponse = customerService.countNewCustomersAtTime(startTime, endTime);

            List<Map<String, Object>> countCustomerJoinResponseJsonList = countCustomerJoinResponse.stream()
                    .map(item -> {
                        Map<String, Object> map = new HashMap<>();
                        map.put("joinAt", item.getJointAt().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
            ...
            responseMap.put("countCustomerJoinList", countCustomerJoinResponseJsonList);

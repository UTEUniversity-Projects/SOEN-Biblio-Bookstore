    ...
    <div class="cr-page-title cr-page-title-2">
      <div class="cr-breadcrumb">
        ...
        <ul>
          ...
          <li><b>Thêm nhà xuất bản</b></li>
        </ul>
      </div>
    </div>
    <div class="row">
      <form id="publisherCreateForm" class="d-flex">
                              ...
                              <div class="avatar-preview cr-preview">
                                <div class="imagePreview cr-div-preview">
                                  <img class="cr-image-preview image-shadow rounded-3"
                                       src="${pageContext.request.contextPath}/images/anonymous/publisher.jpg"
                                       alt="edit">
                                </div>
                              </div>
                            </div>
            ...
            <div class="cr-card-content">
              <div class="row">
                ...
                <div id="editor" name="introduction" class="edit-introduction">
                  Mô tả về nhà xuất bản
                </div>
                <div class="review-area">
                  <div id="review-container d-none">
                    <h5>Giới thiệu nhà xuất bản</h5>

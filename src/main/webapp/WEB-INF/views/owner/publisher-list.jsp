            ...
            <div class="cr-breadcrumb">
                <div class="d-flex align-items-center">
                    <div class="page-title">
                        <h5><b>Danh sách nhà xuất bản</b></h5>
                    </div>
                    <a href="${pageContext.request.contextPath}/owner/publisher/create" class="cr-btn default-btn color-primary">
                        Thêm nhà xuất bản
                    </a>
                </div>
                <ul>
                    <li><a href="${pageContext.request.contextPath}/owner/ecommerce"><b>Biblio</b></a></li>
                    <li><b>Danh sách nhà xuất bản</b></li>
                </ul>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="customer-data-table" class="item-data-table table table-hover rounded-table responsive-table">
                                ...
                                <c:forEach var="publisher" items="${publishers}">
                                    <tr class="item-row" id="row-${publisher.id}" data-id="${publisher.id}">
                                        <td>
                                            <img
                                        ...
                                        <td>
                                            <div>
                                                <span class="row-highlight">${publisher.name}</span><br>
                                                <span class="row-sub-content">Tham gia: ${publisher.joinAt}</span>
                                            </div>
                                        </td>
                                        <td><span class="badge bg-primary">${publisher.works}</span></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h6 class="avg-rate">${publisher.avgRate}</h6>
                                                ...
                                                <c:choose>
                                                    <c:when test="${publisher.perValueBooksSold == 0}">
                                                        <div class="up mt-0 d-flex">
                                                            ...
                                                            <p class="non-growth">${publisher.perValueBooksSold}%</p>
                                                        </div>
                                                    </c:when>
                                                    <c:when test="${publisher.perValueBooksSold > 0}">
                                                        <div class="up mt-0 d-flex">
                                                            <i class="ri-arrow-up-line me-1 icon-growth"></i>
                                                            <p class="up-growth">${publisher.perValueBooksSold}%</p>
                                                        </div>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <div class="down mt-0 d-flex">
                                                            <i class="ri-arrow-down-line me-1 icon-growth"></i>
                                                            <p class="down-growth">${-publisher.perValueBooksSold}%</p>
                                                        </div>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                        ...
                                        <td>
                                            <span class="row-introduction">${publisher.introduction}</span>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#" onclick="rowAction(${publisher.id}, 'view'); return false;" data-value="view">Chi tiết</a>
                                                    <a class="dropdown-item" href="#" onclick="rowAction(${publisher.id}, 'update'); return false;" data-value="update">Cập nhật</a>
                                                    <a class="dropdown-item" href="#" onclick="rowAction(${publisher.id}, 'delete'); return false;" data-value="delete">Xóa</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>

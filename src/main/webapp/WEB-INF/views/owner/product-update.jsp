                            ...
                            <div class="row cr-product-uploads">
                                            ...
                                            <div class="avatar-upload">
                                                <div class="avatar-edit">
                                                    <input type='file' id="imgMain" name="imgMain" class="cr-image-upload"
                                                           accept=".png, .jpg, .jpeg"
                                                    <c:if test="${book.imgUrls.size() > 0}">
                                                            value="${book.imgUrls[0]}"
                                                    </c:if>
                                                    >
                                                ...
                                                <div class="avatar-preview cr-preview">
                                                    <div class="imagePreview cr-div-preview">
                                                        <c:choose>
                                                            <c:when test="${book.imgUrls.size() > 0}">
                                                                <img class="cr-image-preview image-shadow rounded-2"
                                                                     src="${pageContext.request.contextPath}${book.imgUrls[0]}"
                                                                     alt="edit">
                                                            </c:when>
                                                        </c:choose>
                                                    </div>
                                            ...
                                            <div class="thumb-upload-set colo-md-12">
                                                <div class="thumb-upload">
                                                    ...
                                                    <div class="thumb-preview cr-preview">
                                                        <div class="image-thumb-preview">
                                                            <c:choose>
                                                                <c:when test="${book.imgUrls.size() > 1}">
                                                                    <img class="cr-image-preview image-shadow rounded-2"
                                                                         src="${pageContext.request.contextPath}${book.imgUrls[1]}"
                                                                         alt="edit">
                                                                </c:when>
                                                                <c:otherwise>
                                                ...
                                                <div class="thumb-upload">
                                                    ...
                                                    <div class="thumb-preview cr-preview">
                                                        <div class="image-thumb-preview">
                                                            <c:choose>
                                                                <c:when test="${book.imgUrls.size() > 2}">
                                                                    <img class="cr-image-preview image-shadow rounded-2"
                                                                         src="${pageContext.request.contextPath}${book.imgUrls[2]}"
                                                                         alt="edit">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <img class="image-thumb-preview cr-image-preview"
                                                ...
                                                <div class="thumb-upload">
                                                    ...
                                                    <div class="thumb-preview cr-preview">
                                                        <div class="image-thumb-preview">
                                                            <c:choose>
                                                                <c:when test="${book.imgUrls.size() > 3}">
                                                                    <img class="cr-image-preview image-shadow rounded-2"
                                                                         src="${pageContext.request.contextPath}${book.imgUrls[3]}"
                                                                         alt="edit">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <img class="image-thumb-preview cr-image-preview"
                                                ...
                                                <div class="thumb-upload">
                                                    ...
                                                    <div class="thumb-preview cr-preview">
                                                        <div class="image-thumb-preview">
                                                            <c:choose>
                                                                <c:when test="${book.imgUrls.size() > 4}">
                                                                    <img class="cr-image-preview image-shadow rounded-2"
                                                                         src="${pageContext.request.contextPath}${book.imgUrls[4]}"
                                                                         alt="edit">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <img class="image-thumb-preview cr-image-preview"
                                                ...
                                                <div class="thumb-upload">
                                                    ...
                                                    <div class="thumb-preview cr-preview">
                                                        <div class="image-thumb-preview">
                                                            <c:choose>
                                                                <c:when test="${book.imgUrls.size() > 5}">
                                                                    <img class="cr-image-preview image-shadow rounded-2"
                                                                         src="${pageContext.request.contextPath}${book.imgUrls[5]}"
                                                                         alt="edit">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <img class="image-thumb-preview cr-image-preview"
                                                ...
                                                <div class="thumb-upload">
                                                    ...
                                                    <div class="thumb-preview cr-preview">
                                                        <div class="image-thumb-preview">
                                                            <c:choose>
                                                                <c:when test="${book.imgUrls.size() > 6}">
                                                                    <img class="cr-image-preview image-shadow rounded-2"
                                                                         src="${pageContext.request.contextPath}${book.imgUrls[6]}"
                                                                         alt="edit">
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <img class="image-thumb-preview cr-image-preview"
                                ...
                                <div class="col-lg-8">
                                    <div class="row g-3 ps-3">
                                        <label for="id"></label><input id="id" name="id" type="text" value="${book.id}" hidden="hidden">
                                        <div class="col-md-12">
                                            <label for="title" class="form-label">Tên sản phẩm<sup class="color-secondary" style="font-size: 100%">*</sup></label>
                                            <input id="title" name="title" type="text" class="form-control slug-title" value="${book.title}">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input  id="sellingPrice" name="sellingPrice" type="text" class="form-control slug-title"
                                                    placeholder="Đơn vị: VNĐ" value="${book.sellingPrice}">
                                        </div>
                                        <div class="col-md-2">
                                            <label for="quantity" class="form-label">Số lượng<sup class="color-secondary" style="font-size: 100%">*</sup></label>
                                            <input id="quantity" name="quantity" type="number" class="form-control" placeholder="100" value="${book.quantity}">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select id="authorIds" name="authorIds" class="form-control form-select select2" multiple="multiple">
                                                <c:forEach var="author" items="${init.authors}">
                                                    ...
                                                    <c:forEach var="selected" items="${book.authorIds}">
                                                        <c:if test="${author.id == selected}">
                                                            <c:set var="isSelected" value="true" />
                                                        </c:if>
                                                    </c:forEach>
                                                    <option class="option-value" value="${author.id}"
                                                ...
                                                <c:forEach var="category" items="${init.categories}">
                                                    <optgroup label="${category.name}">
                                                        <c:forEach var="subCategory" items="${category.subCategories}">
                                                            <option class="option-value" value="${subCategory.id}" <c:if test="${subCategory.id == book.subCategoryId}">selected</c:if>>
                                                                    ${subCategory.name}
                                                            </option>
                                                        </c:forEach>
                                                    </optgroup>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="translatorIds" name="translatorIds" class="form-control form-select select2"  multiple="multiple">
                                                <c:forEach var="translator" items="${init.translators}">
                                                    <c:set var="isSelected" value="false" />
                                                    <c:forEach var="selected" items="${book.translatorIds}">
                                                        <c:if test="${translator.id == selected}">
                                                            <c:set var="isSelected" value="true" />
                                                        </c:if>
                                                    </c:forEach>
                                                    <option class="option-value" value="${translator.id}"
                                                            <c:if test="${isSelected}">selected</c:if>>
                                                            ${translator.name}
                                                    </option>
                                                </c:forEach>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="conditionCode" name="conditionCode" class="form-control form-select select2">
                                                <c:forEach var="condition" items="${init.conditions}">
                                                    <option class="option-value" value="${condition.key}" <c:if test="${condition.key == book.conditionCode}">selected</c:if>>
                                                            ${condition.value}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="publisherId" name="publisherId" class="form-control form-select select2">
                                                <c:forEach var="publisher" items="${init.publishers}">
                                                    <option class="option-value" value="${publisher.id}" <c:if test="${publisher.id == book.publisherId}">selected</c:if>>
                                                            ${publisher.name}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="formatCode" name="formatCode" class="form-control form-select select2">
                                                <c:forEach var="format" items="${init.formats}">
                                                    <option class="option-value" value="${format.key}" <c:if test="${format.key == book.formatCode}">selected</c:if>>
                                                            ${format.value}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="publicationDate" name="publicationDate" type="date" class="form-control"
                                                   placeholder="MM/dd/yyyy" value="${book.publicationDate}"/>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select id="languageCodes" name="languageCodes" class="form-control form-select select2" multiple="multiple">
                                                <c:forEach var="language" items="${init.languages}">
                                                    <c:set var="isSelected" value="false" />
                                                    <c:forEach var="selected" items="${book.languageCodes}">
                                                        <c:if test="${language.key == selected}">
                                                            <c:set var="isSelected" value="true" />
                                                        </c:if>
                                                    </c:forEach>
                                                    <option class="option-value" value="${language.key}"
                                                            <c:if test="${isSelected}">selected</c:if>>
                                                            ${language.value}
                                                    </option>
                                                </c:forEach>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="ageRecommendCode" name="ageRecommendCode" class="form-control form-select select2">
                                                <c:forEach var="ageRecommend" items="${init.ageRecommends}">
                                                    <option class="option-value" value="${ageRecommend.key}" <c:if test="${ageRecommend.key == book.ageRecommendCode}">selected</c:if>>
                                                            ${ageRecommend.value}
                                                    </option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input id="codeISBN10" name="codeISBN10" type="text" class="form-control slug-title" value="${book.codeISBN10}">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="codeISBN13" class="form-label">ISBN13<sup class="color-secondary" style="font-size: 100%">*</sup></label>
                                            <input id="codeISBN13" name="codeISBN13" type="text" class="form-control slug-title" value="${book.codeISBN13}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input id="edition" name="edition" type="text" class="form-control slug-title"
                                                   placeholder="3" value="${book.edition}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input id="hardcover" name="hardcover" type="text" class="form-control slug-title"
                                                   placeholder="125" value="${book.hardcover}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input id="length" name="length" type="text" class="form-control slug-title"
                                                   placeholder="Đơn vị: cm" value="${book.length}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input id="width" name="width" type="text" class="form-control slug-title"
                                                   placeholder="Đơn vị: cm" value="${book.width}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input id="height" name="height" type="text" class="form-control slug-title"
                                                   placeholder="Đơn vị: cm" value="${book.height}">
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <input id="weight" name="weight" type="text" class="form-control slug-title"
                                                   placeholder="Đơn vị: kg" value="${book.weight}">
                                        </div>
                                        <hr>
                                        <div class="col-md-12">
                                            <div class="row ps-3">

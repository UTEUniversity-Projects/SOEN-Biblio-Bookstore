                        ...
                        <div class="cr-card card-3d-deep">
                            ...
                            <div class="cr-vendor-info">
                                <ul>
                                    ...
                                    <li><span class="label">Cùng tác giả :</span>&nbsp; <b>${author.works}</b> tác phẩm</li>
                                </ul>
                            </div>
                        </div>
                        <div class="cr-card card-3d-deep">
                        ...
                        <div class="cr-card vendor-profile card-3d-deep">
                            <div class="cr-card-content">
                                ...
                                <span class="cr-sub-cat-list">
                                    <c:forEach var="subCategory" items="${author.topSubCategory}" varStatus="status">
                                        <div class="d-flex align-items-center">
                                            <c:choose>
                                ...
                                <div class="cr-vendor-info">
                                    <ul>
                                        <li><span class="label">Đã bán :</span>&nbsp;
                                            <b>${author.booksSold}</b> quyển
                                        </li>
                                        <li><span class="label">Tồn kho :</span>&nbsp;
                                            <b>${author.booksInStock}</b> quyển
                                        </li>
                                        <li><span class="label">Bị hủy đơn :</span>&nbsp;
                                            <b>${author.booksCancelled}</b> quyển
                                        </li>
                                        <li><span class="label">Bị hoàn trả :</span>&nbsp;
                                            <b>${author.booksReturned}</b> quyển
                                        </li>
                                    </ul>
                                </div>
                            </div>

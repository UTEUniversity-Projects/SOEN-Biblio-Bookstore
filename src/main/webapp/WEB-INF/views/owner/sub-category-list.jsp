            ...
            <div class="cr-breadcrumb">
                <div class="d-flex align-items-center">
                    <div class="page-title">
                        <h5><b>Danh sách thể loại</b></h5>
                    </div>
                    <a href="${pageContext.request.contextPath}/owner/sub-category/create" class="cr-btn default-btn color-primary">
                        Thêm thể loại
                    </a>
                </div>
                <ul>
                    <li><a href="${pageContext.request.contextPath}/owner/ecommerce"><b>Biblio</b></a></li>
                    <li><b>Danh sách thể loại</b></li>
                </ul>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="customer-data-table" class="item-data-table table table-hover rounded-table responsive-table">
                                ...
                                <c:forEach var="subCategory" items="${subCategories}">
                                    <tr class="item-row" id="row-${subCategory.id}" data-id="${subCategory.id}">
                                        <td>
                                            <img
                                        ...
                                        <td>
                                            <div>
                                                <span class="row-highlight">${subCategory.name}</span><br>
                                                <span class="row-sub-content">Danh mục: ${subCategory.category}</span>
                                            </div>
                                        </td>
                                        <td><span class="badge bg-primary">${subCategory.works}</span></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <h6 class="avg-rate">${subCategory.avgRate}</h6>
                                                ...
                                                <c:choose>
                                                    <c:when test="${subCategory.perValueBooksSold == 0}">
                                                        <div class="up mt-0 d-flex">
                                                            ...
                                                            <p class="non-growth">${subCategory.perValueBooksSold}%</p>
                                                        </div>
                                                    </c:when>
                                                    <c:when test="${subCategory.perValueBooksSold > 0}">
                                                        <div class="up mt-0 d-flex">
                                                            <i class="ri-arrow-up-line me-1 icon-growth"></i>
                                                            <p class="up-growth">${subCategory.perValueBooksSold}%</p>
                                                        </div>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <div class="down mt-0 d-flex">
                                                            <i class="ri-arrow-down-line me-1 icon-growth"></i>
                                                            <p class="down-growth">${-subCategory.perValueBooksSold}%</p>
                                                        </div>
                                                    </c:otherwise>
                                                </c:choose>
                                            </div>
                                        ...
                                        <td>
                                            <span class="row-fullScript">${subCategory.fullScript}</span>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#" onclick="rowAction(${subCategory.id}, 'view'); return false;" data-value="view">Chi tiết</a>
                                                    <a class="dropdown-item" href="#" onclick="rowAction(${subCategory.id}, 'update'); return false;" data-value="update">Cập nhật</a>
                                                    <a class="dropdown-item" href="#" onclick="rowAction(${subCategory.id}, 'delete'); return false;" data-value="delete">Xóa</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>

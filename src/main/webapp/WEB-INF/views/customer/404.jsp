...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/customer/css/vendor/tailwind.min.css"/>
...
<div class="bg-gray-100 h-screen flex flex-col items-center justify-center">
    <center class="m-auto">
        ...
        <div class=" tracking-widest mt-4">
            <span class="text-gray-500 text-6xl block"><span>404</span></span>
            <span class="text-gray-500 text-xl">Không tìm thấy trang !</span>

        </div>
        <center class="mt-6">
            <a href="home" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Trở về trang chủ</a>
        </center>
    </center>
</div>
